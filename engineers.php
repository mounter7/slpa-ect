...
<head>
  ...
  <title>Engineers - ECT Staff</title>
...
<body>
  ...
  <section class="home-section-1" id="home-section-1">
    <div class="container">
      ...
      $query = mysqli_query($conn, "SELECT * FROM slpa_ect_staff WHERE position='engineer' ");
  ...
  <script>
    document.querySelector('.tag:nth-child(1)').classList.add('active')
  </script>
</body>
</body>
